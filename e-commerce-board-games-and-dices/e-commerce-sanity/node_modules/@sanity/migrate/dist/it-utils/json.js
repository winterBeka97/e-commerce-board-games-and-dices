...
/**
 * @public
 */ export function parseJSON(_0) {
    return _wrap_async_generator(function(it) {
        var _ref, _ref_parse, parse, _iteratorAbruptCompletion, _didIteratorError, _iteratorError, _iterator, _step, _value, chunk, err;
        var _arguments = arguments;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    _ref = _arguments.length > 1 && _arguments[1] !== void 0 ? _arguments[1] : {}, _ref_parse = _ref.parse, parse = _ref_parse === void 0 ? JSON.parse : _ref_parse;
...
/**
 * @public
 */ export function stringifyJSON(it) {
