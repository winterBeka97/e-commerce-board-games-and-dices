...
/**
 * @public
 */ export function split(it, delimiter) {
    return _wrap_async_generator(function() {
        var buf, _iteratorAbruptCompletion, _didIteratorError, _iteratorError, _iterator, _step, _value, chunk, lastIndex, parts, _iteratorNormalCompletion, _didIteratorError1, _iteratorError1, _iterator1, _step1, part, err, err1;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                ...
                case 3:
                    ...
                    chunk = _value;
                    buf += chunk;
                    if (!buf.includes(delimiter)) return [
                        3,
                        12
                    ];
                    lastIndex = buf.lastIndexOf(delimiter);
                    parts = buf.slice(0, Math.max(0, lastIndex)).split(delimiter);
                ...
                case 4:
                    ...
                    _iterator1 = parts[Symbol.iterator]();
                    _state.label = 5;
                case 5:
