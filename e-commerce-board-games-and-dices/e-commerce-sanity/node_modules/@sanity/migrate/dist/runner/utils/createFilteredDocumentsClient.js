...
export function createFilteredDocumentsClient(getFilteredDocumentsReadableStream) {
    ...
    function getDocumentsFromBuffer(ids) {
        return _async_to_generator(function() {
            var found, remaining, _iteratorAbruptCompletion, _didIteratorError, _iteratorError, _iterator, _step, _value, doc, err;
            return _ts_generator(this, function(_state) {
                switch(_state.label){
                    ...
                    case 1:
                        ...
                        _iterator = _async_iterator(getAllDocumentsFromBuffer());
                        _state.label = 2;
                    case 2:
                        return [
                            4,
    ...
    function getDocumentFromBuffer(id) {
        return _async_to_generator(function() {
            return _ts_generator(this, function(_state) {
                switch(_state.label){
                    case 0:
