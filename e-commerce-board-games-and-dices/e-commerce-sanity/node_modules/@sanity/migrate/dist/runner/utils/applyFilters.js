...
export function applyFilters(migration, documents) {
    return _wrap_async_generator(function() {
        var documentTypes, parsedFilter, _iteratorAbruptCompletion, _didIteratorError, _iteratorError, _iterator, _step, _value, doc, _tmp, err;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    documentTypes = migration.documentTypes;
                    parsedFilter = migration.filter ? parseGroqFilter(migration.filter) : undefined;
                ...
                case 1:
                    ...
                    _iterator = _async_iterator(documents);
                    _state.label = 2;
                case 2:
                    return [
                        4,
                ...
                case 3:
                    ...
                    return [
                        4,
                        _await_async_generator(matchesFilter(parsedFilter, doc))
                    ];
                case 4:
                    _tmp = !_state.sent();
                    _state.label = 5;
