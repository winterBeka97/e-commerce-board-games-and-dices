 ...
 * ```
 */ export var setIfMissing = function setIfMissing(value) {
    return {
        type: 'setIfMissing',
        value: value
    };
 ...
 * ```
 */ export var unset = function unset() {
    return {
        type: 'unset'
    };
};
 ...
 * @public
 */ export var diffMatchPatch = function diffMatchPatch(value) {
    return {
        type: 'diffMatchPatch',
        value: value
    };
 ...
 * ```
 */ export var insertAfter = function insertAfter(items, indexOrReferenceItem) {
