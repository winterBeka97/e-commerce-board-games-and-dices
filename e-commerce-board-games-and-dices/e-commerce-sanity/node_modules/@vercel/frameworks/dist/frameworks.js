...
__reExport(frameworks_exports, require("./types"), module.exports);
const { readdir, readFile, unlink } = import_fs.promises;
const frameworks = [
  {
  ...
  },
  {
    ...
    defaultRoutes: async (dirPrefix) => {
      try {
        const nowRoutesPath = (0, import_path.join)(
          dirPrefix,
          "public",
  ...
  },
  {
    ...
    getOutputDirName: async (dirPrefix) => {
      const base = "build";
      try {
        const location = (0, import_path.join)(dirPrefix, base);
  ...
  },
  {
    ...
    dependency: "@dojo/cli",
    getOutputDirName: async () => (0, import_path.join)("output", "dist"),
    defaultRoutes: [
      {
        handle: "filesystem"
      },
  ...
  },
  {
    ...
    getOutputDirName: async (dirPrefix) => {
      ...
      try {
        ...
        return (0, import_path.join)(base, paths[0]);
      } catch (error) {
        console.error(`Error detecting output directory: `, error);
      }
      return base;
    ...
    getOutputDirName: async (dirPrefix) => {
      const config = await (0, import_read_config_file.readConfigFile)(
        ["config.json", "config.yaml", "config.toml"].map((fileName) => {
          return (0, import_path.join)(dirPrefix, fileName);
        })
      );
  ...
  },
  {
    ...
    getOutputDirName: async (dirPrefix) => {
      const config = await (0, import_read_config_file.readConfigFile)(
        (0, import_path.join)(dirPrefix, "_config.yml")
      );
...
var frameworks_default = frameworkList;
