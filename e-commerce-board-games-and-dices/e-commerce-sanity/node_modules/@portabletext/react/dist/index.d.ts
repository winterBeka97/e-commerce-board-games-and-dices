import { ToolkitListNestMode, ToolkitListNestMode as ListNestMode, ToolkitPortableTextList, ToolkitPortableTextListItem, toPlainText } from "@portabletext/toolkit";
import { ComponentType, JSX, ReactNode } from "react";
import { ArbitraryTypedObject, PortableTextBlock, PortableTextBlock as PortableTextBlock$1, PortableTextBlockStyle, PortableTextListItemBlock, PortableTextListItemType, TypedObject } from "@portabletext/types";
/**
* Properties for the Portable Text react component
*
* @template B Types that can appear in the array of blocks
*/
interface PortableTextProps<B extends TypedObject = PortableTextBlock$1 | ArbitraryTypedObject> {
  /**
...
*/
type PortableTextBlockComponent = PortableTextComponent<PortableTextBlock$1>;
/**
...
type DefaultPortableTextBlockStyle = BuiltInPortableTextString<PortableTextBlockStyle>;
...
type CustomPortableTextBlockStyleName<B extends TypedObject> = Exclude<PortableTextBlockStyleName<B>, DefaultPortableTextBlockStyle>;
...
type DefaultPortableTextListItem = BuiltInPortableTextString<PortableTextListItemType>;
type CustomPortableTextListItemName<B extends TypedObject> = Exclude<PortableTextListItemName<B>, DefaultPortableTextListItem>;
...
type DefaultPortableTextMark = "em" | "strong" | "code" | "underline" | "strike-through" | "link";
type CustomPortableTextMarkTypeName<B extends TypedObject> = Exclude<PortableTextMarkTypeName<B>, DefaultPortableTextMark>;
...
type PortableTextValueItem<T> = Extract<NonNullable<T> extends readonly (infer B)[] ? B : NonNullable<T>, TypedObject>;
type PortableTextArrayItem<T> = NonNullable<T> extends readonly (infer Item)[] ? Extract<NonNullable<Item>, {
  _type: "block";
}> extends never ? never : Extract<NonNullable<Item>, TypedObject> : never;
type InferPortableTextTypedObject<T> = T extends unknown ? PortableTextArrayItem<T> extends never ? NonNullable<T> extends readonly (infer Item)[] ? InferPortableTextTypedObject<Item> : NonNullable<T> extends object ? { [Key in keyof NonNullable<T>]: InferPortableTextTypedObject<NonNullable<T>[Key]> }[keyof NonNullable<T>] : never : PortableTextArrayItem<T> : never;
type StrictPortableTextTypeComponents<B extends TypedObject> = string extends CustomPortableTextTypeName<B> ? Record<string, PortableTextTypeComponent | undefined> : CustomPortableTextTypeName<B> extends never ? Record<string, never> : { [Type in CustomPortableTextTypeName<B>]-?: PortableTextTypeComponent<Extract<CustomPortableTextType<B>, {
  _type: Type;
}>> };
type StrictPortableTextTypeComponentOverrides<B extends TypedObject> = CustomPortableTextTypeName<B> extends never ? {
  types?: StrictPortableTextTypeComponents<B>;
} : {
  types: StrictPortableTextTypeComponents<B>;
};
type StrictPortableTextMarkComponents<B extends TypedObject> = string extends PortableTextMarkTypeName<B> ? Record<string, PortableTextMarkComponent | undefined> : PortableTextMarkTypeName<B> extends never ? Record<string, never> : { [Type in CustomPortableTextMarkTypeName<B>]-?: PortableTextMarkComponent<Extract<PortableTextMarkType<B>, {
  _type: Type;
}>> } & { [Type in Extract<DefaultPortableTextMark, PortableTextMarkTypeName<B>>]?: PortableTextMarkComponent<Extract<PortableTextMarkType<B>, {
  _type: Type;
}>> };
type StrictPortableTextMarkComponentOverrides<B extends TypedObject> = CustomPortableTextMarkTypeName<B> extends never ? {
  marks?: StrictPortableTextMarkComponents<B>;
} : {
  marks: StrictPortableTextMarkComponents<B>;
};
type StrictPortableTextBlockComponents<B extends TypedObject> = string extends PortableTextBlockStyleName<B> ? LooseRecord<PortableTextBlockStyle, PortableTextBlockComponent | undefined> : PortableTextBlockStyleName<B> extends never ? Record<string, never> : { [Style in CustomPortableTextBlockStyleName<B>]-?: PortableTextComponent<PortableTextBlockForStyle<B, Style>> } & { [Style in Extract<DefaultPortableTextBlockStyle, PortableTextBlockStyleName<B>>]?: PortableTextComponent<PortableTextBlockForStyle<B, Style>> };
type StrictPortableTextBlockComponentOverrides<B extends TypedObject> = CustomPortableTextBlockStyleName<B> extends never ? {
  block?: StrictPortableTextBlockComponents<B> | PortableTextBlockComponentFor<B>;
} : {
  block: StrictPortableTextBlockComponents<B> | PortableTextBlockComponentFor<B>;
};
type StrictPortableTextListComponents<B extends TypedObject> = string extends PortableTextListItemName<B> ? LooseRecord<PortableTextListItemType, PortableTextListComponent | undefined> : PortableTextListItemName<B> extends never ? Record<string, never> : { [ListItem in CustomPortableTextListItemName<B>]-?: PortableTextComponent<PortableTextListForItem<ListItem>> } & { [ListItem in Extract<DefaultPortableTextListItem, PortableTextListItemName<B>>]?: PortableTextComponent<PortableTextListForItem<ListItem>> };
type StrictPortableTextListComponentOverrides<B extends TypedObject> = CustomPortableTextListItemName<B> extends never ? {
  list?: StrictPortableTextListComponents<B> | PortableTextListComponentFor<B>;
} : {
  list: StrictPortableTextListComponents<B> | PortableTextListComponentFor<B>;
};
type StrictPortableTextListItemComponents<B extends TypedObject> = string extends PortableTextListItemName<B> ? LooseRecord<PortableTextListItemType, PortableTextListItemComponent | undefined> : PortableTextListItemName<B> extends never ? Record<string, never> : { [ListItem in PortableTextListItemName<B>]-?: PortableTextComponent<PortableTextBlockForListItem<B, ListItem>> };
...
* ```
*/
type InferComponents<T> = PortableTextComponents<PortableTextValueItem<T>>;
/**
...
* ```
*/
type InferValue<T> = Exclude<InferPortableTextTypedObject<T>, undefined>[];
/**
...
*/
type InferStrictComponents<T> = Omit<PortableTextComponents<PortableTextValueItem<T>>, "types" | "marks" | "block" | "list" | "listItem"> & StrictPortableTextTypeComponentOverrides<PortableTextValueItem<T>> & StrictPortableTextMarkComponentOverrides<PortableTextValueItem<T>> & StrictPortableTextBlockComponentOverrides<PortableTextValueItem<T>> & StrictPortableTextListComponentOverrides<PortableTextValueItem<T>> & StrictPortableTextListItemComponentOverrides<PortableTextValueItem<T>>;
/**
...
interface PortableTextReactComponents<B extends TypedObject = any> {
  ...
  */
  unknownBlockStyle: PortableTextComponent<PortableTextBlock$1>;
  /**
...
interface SerializedBlock {
  ...
  index: number;
  isInline: boolean;
  node: PortableTextBlock$1 | PortableTextListItemBlock;
}
/**
...
*/
type ReactPortableTextListItem = ToolkitPortableTextListItem;
declare const defaultComponents: PortableTextReactComponents;
declare function mergeComponents(parent: PortableTextReactComponents, overrides: PortableTextComponents): PortableTextReactComponents;
declare function PortableText<B extends TypedObject = PortableTextBlock$1>({
  value: input,
  components: componentOverrides,
  listNestingMode,
  onMissingComponent: missingComponentHandler
}: PortableTextProps<B>): JSX.Element;
export { DefaultPortableTextBlockStyle, DefaultPortableTextListItem, DefaultPortableTextMark, InferComponents, InferStrictComponents, InferValue, type ListNestMode, MissingComponentHandler, NodeRenderer, NodeType, PortableText, type PortableTextBlock, PortableTextBlockComponent, PortableTextComponent, PortableTextComponentProps, PortableTextComponents, PortableTextListComponent, PortableTextListItemComponent, PortableTextMarkComponent, PortableTextMarkComponentProps, PortableTextProps, PortableTextReactComponents, PortableTextTypeComponent, PortableTextTypeComponentProps, ReactPortableTextList, ReactPortableTextListItem, Serializable, SerializedBlock, UnknownNodeType, defaultComponents, mergeComponents, toPlainText };
