 ...
 * @beta
 */
declare const DocumentListPane: _$react.MemoExoticComponent<(props: BaseStructureToolPaneProps<'documentList'>) => _$react.JSX.Element>;
/**
 * @deprecated Import from `sanity/structure` instead!
 * @hidden
 * @beta
 */
declare const DocumentPane: _$react.MemoExoticComponent<(props: DocumentPaneProviderProps$1) => _$react.JSX.Element>;
/**
 * @deprecated Import from `sanity/structure` instead!
 * @hidden
 * @beta
 */
declare const DocumentPaneProvider: _$react.MemoExoticComponent<(props: DocumentPaneProviderProps$1) => _$react.JSX.Element>;
/**
 * @deprecated Import from `sanity/structure` instead!
 * @hidden
 * @beta
